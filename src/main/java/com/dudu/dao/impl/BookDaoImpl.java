...
public class BookDaoImpl implements BookDao {
    ...
    public Page queryBookList(Map<String, Object> params) {
        ...
        Page page = new Page(sql.toString(), Integer.parseInt(params.get("currentPage").toString()), Integer.parseInt(params.get("pageSize").toString()), jdbcTemplate, Book.class);
        return page;
    }
